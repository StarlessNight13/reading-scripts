...
function getRequiredPageElements(): {
    ...
    volumesSelectElement: HTMLSelectElement;
} | null {
    ...
    if (!novelLinkElement || !chaptersSelectElementsNodeList.length || !volumesSelectElement) {
        console.warn(
 ...
 */
function buildChapterSelectorsMap(chaptersSelectElementsNodeList: NodeListOf<HTMLSelectElement>): Map<string, HTMLSelectElement> {
 ...
 */
function parseChapterDetails(chapterText: string, defaultIndex: number): { title: string; chapterIndex: number; } {
...
): { chapters: ChapterInfo[]; selectedChapterIndex: number; } {
...
function extractChaptersMetaData(): ChaptersMetaData | null {
    ...
    const chapterSelectorsMap = buildChapterSelectorsMap(chaptersSelectElementsNodeList);
